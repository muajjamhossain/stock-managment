      ...
      <div class="card">
        <form method="post" action="{{url('dashboard/supplier/update')}}" enctype="multipart/form-data">
          ...
          <div class="card-header card_header">
            <div class="row">
              <div class="col-md-8 card_header_title text-uppercase">
                <i class="uil uil-layer-group"></i>Edit supplier
              </div>
          ...
          <div class="card-body card_body">
            ...
            <input type="hidden" name="supplier_slug" value="{{$supplier->supplier_slug}}">
            <div class="row mb-3 {{ $errors->has('supplier_name') ? ' has-error' : '' }}">
              ...
              <div class="col-lg-7">
                  <input type="text" class="form-control form_control" id="" name="supplier_name" value="{{$supplier->supplier_name}}">
            ...
            <div class="row mb-3 {{ $errors->has('supplier_email') ? ' has-error' : '' }}">
              ...
              <div class="col-lg-7">
                  <input type="text" class="form-control bg-light form_control" id="" name="supplier_email" value="{{$supplier->supplier_email}}" disabled>
              </div>
            </div>
            <div class="row mb-3 {{ $errors->has('supplier_phone') ? ' has-error' : '' }}">
              ...
              <div class="col-lg-7">
                  <input type="text" class="form-control form_control" id="" name="supplier_phone" value="{{$supplier->supplier_phone}}">
            ...
            <div class="row mb-3 {{ $errors->has('supplier_address') ? ' has-error' : '' }}">
              ...
              <div class="col-lg-7">
                  <input type="text" class="form-control form_control" id="" name="supplier_address" value="{{$supplier->supplier_address}}">
